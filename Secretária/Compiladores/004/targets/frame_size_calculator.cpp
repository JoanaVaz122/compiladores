...
void udf::frame_size_calculator::do_left_index_node(udf::left_index_node *const node, int lvl) {
  // EMPTY
}
...
void udf::frame_size_calculator::do_object_node(udf::object_node *const node, int lvl) {
  // EMPTY
}
